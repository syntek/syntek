...
public class formMain extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        tblListFile.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {null, null, null, null},
                {null, null, null, null},
                {null, null, null, null},
        ...
        jScrollPane2.setViewportView(tblListFile);
    ...
    private void listFileMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_listFileMouseClicked
        txtID.setText(getId(listFile.getSelectedValue().toString()));
        updateDataTable(txtID.getText());
